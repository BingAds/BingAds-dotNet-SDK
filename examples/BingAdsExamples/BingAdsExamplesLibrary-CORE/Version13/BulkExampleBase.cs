...
{
    public abstract class BulkExampleBase
    {
        public LogggingBase.SendMessageDelegate OutputStatusMessage;

        public BulkExampleBase(BulkServiceManager _sericeManager)
        {
            OutputStatusMessage = LogggingBase.OutputStatusMessageDefault;
            BulkServiceManager = _sericeManager;
        }
        ...
        /// <summary>
        /// This is created for teh output messages only.
        /// </summary>
        ...
        protected BulkEntity GetBulkAdGroupNegativeKeyword()
        {
            ...
            var bulkAdGroupNegativeKeyword = new BulkAdGroupNegativeKeyword
            {
                ...
                NegativeKeyword = new NegativeKeyword
                {
                    ...
                    MatchType = Microsoft.BingAds.V13.CampaignManagement.MatchType.Exact,
                    // 'Text' column header in the Bulk file
                    Text = "shoes"
                },
        ...
        protected BulkEntity GetBulkKeyword()
        {
            ...
            var bulkKeyword = new BulkKeyword
            {
                ...
                Keyword = new Keyword
                {
                    ...
                    Id = null,
                    // 'Match Type' column header in the Bulk file
                    MatchType = Microsoft.BingAds.V13.CampaignManagement.MatchType.Broad,
