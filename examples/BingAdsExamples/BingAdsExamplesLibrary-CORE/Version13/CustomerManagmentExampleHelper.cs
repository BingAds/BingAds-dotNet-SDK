...
{
    public class CustomerManagementExampleHelper
    {
        ...
        public CustomerManagementExampleHelper(ServiceClient<ICustomerManagementService> _serviceClient)
        {
            OutputStatusMessage = LogggingBase.OutputStatusMessageDefault;
            CustomerManagementService = _serviceClient;
        }
