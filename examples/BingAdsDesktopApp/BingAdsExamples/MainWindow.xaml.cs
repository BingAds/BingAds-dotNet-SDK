...
namespace BingAdsExamples
{
    ...
    public partial class MainWindow
    {
        private readonly ExampleBase[] _examples =
            {
                new V10.BudgetOpportunities(),
                new V10.BulkServiceManagerDemo(),
                new V10.BulkAdExtensions(),
                new V10.AdExtensions(),
                new V10.BulkKeywordsAds(),
                new V10.KeywordsAds(),
                new V10.BulkNegativeKeywords(),
                new V10.NegativeKeywords(),
                new V10.BulkProductPartitionUpdateBid(),
                new V10.BulkShoppingCampaigns(),
                new V10.ShoppingCampaigns(), 
                new V10.BulkTargets(),
                new V10.Targets(),
                new V10.BulkNegativeSites(),
                new GeographicalLocations(),
                new V9.SearchUserAccounts(), 
                new V9.ManageClient(), 
                new V9.ReportRequests(),
                new V9.BulkAdExtensions(),
                new V9.AdExtensions(),
                new V9.BulkShoppingCampaigns(),
                new V9.ShoppingCampaigns(), 
                new V9.BulkTargets(),
                new V9.Targets(), 
                new V9.BulkKeywordsAds(),
                new V9.KeywordsAds(), 
                new V9.NegativeKeywords(), 
                new V9.EstimatedBid(), 
                new V9.OptimizeBudget(), 
            };
        ...
        public async void ExecuteExample(ExampleBase example)
        {
            try
            {
                ...
                OutputStatusMessage(string.Format("Example finished running: {0}\n", example.ExampleName));
            }
