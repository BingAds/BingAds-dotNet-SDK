...
namespace Microsoft.BingAds
{
    ...
    public class GoogleOAuthDesktopMobileAuthCodeGrant : OAuthWithAuthorizationCode
    {
        /// <summary>
        /// Initializes a new instance of the GoogleOAuthDesktopMobileAuthCodeGrant class with the specified ClientId.
        /// </summary>
        /// <param name="clientId">
        /// The Google OAuth client identifier corresponding to your registered Google application.  
        /// </param>
        /// <param name="environment">Bing Ads API environment (Production or Sandbox)</param>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// Note: This creates Google OAuth authentication for desktop/mobile applications.
        /// </para>
        /// </remarks>
        public GoogleOAuthDesktopMobileAuthCodeGrant(
            string clientId,
            string clientSecret,
            ApiEnvironment environment = ApiEnvironment.Production)
            : base(clientId, clientSecret, null, environment, OAuthScope.GOOGLE_OPENID, null, false)
        {
        }

        /// <summary>
        /// Initializes a new instance of the GoogleOAuthDesktopMobileAuthCodeGrant class with the specified ClientId and RefreshToken.
        /// </summary>
        /// <param name="clientId">
        /// The Google OAuth client identifier corresponding to your registered Google application.  
        /// </param>
        ...
        public GoogleOAuthDesktopMobileAuthCodeGrant(
            ...
            string refreshToken,
            ApiEnvironment environment = ApiEnvironment.Production)
            : base(clientId, clientSecret, null, refreshToken, environment, OAuthScope.GOOGLE_OPENID, null, false)
        {
        }

        /// <summary>
        /// Initializes a new instance of the GoogleOAuthDesktopMobileAuthCodeGrant class with the specified ClientId, RedirectionUri, and RefreshToken.
        /// </summary>
        /// <param name="clientId">
        /// The Google OAuth client identifier corresponding to your registered Google application.  
        /// </param>
        ...
        /// </para>
        /// <para>
        /// Use this constructor when you have both a custom redirection URI and a Google refresh token.
        /// </para>
        /// </remarks>
        public GoogleOAuthDesktopMobileAuthCodeGrant(
            string clientId,
            ...
            string refreshToken,
            ApiEnvironment environment = ApiEnvironment.Production)
            : base(clientId, null, redirectionUri, refreshToken, environment, OAuthScope.GOOGLE_OPENID, null, false)
        {
        }
    }
}