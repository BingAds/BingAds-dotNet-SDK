...
namespace Microsoft.BingAds.V13.Internal.Bulk
{
    ...
    /// </summary>
    internal class BulkStreamReader :  BulkRecordReader
    {
        public BulkStreamReader(IBulkObjectReader reader) : base(reader)
        {
        }

        public BulkStreamReader(string fileName, DownloadFileType fileType) : base(new BulkObjectReader(fileName, fileType == DownloadFileType.Csv? ',' : '\t'))
        {
        }
