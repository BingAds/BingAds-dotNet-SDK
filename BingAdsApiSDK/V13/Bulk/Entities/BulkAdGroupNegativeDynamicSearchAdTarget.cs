...
namespace Microsoft.BingAds.V13.Bulk.Entities
{
    /// <summary>
    /// <para>
    /// Represents an Ad Group Negative Dynamic Search Ad Target that can be read or written in a bulk file.
    /// </para>
    /// <para>For more information, see <see href="https://go.microsoft.com/fwlink/?linkid=846127">Ad Group Negative Dynamic Search Ad Target</see> </para>
    /// </summary>
    /// <seealso cref="BulkServiceManager"/>
    /// <seealso cref="BulkOperation{TStatus}"/>
    /// <seealso cref="BulkFileReader"/>
    /// <seealso cref="BulkFileWriter"/>
    public class BulkAdGroupNegativeDynamicSearchAdTarget : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupNegativeDynamicSearchAdTarget>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkAdGroupNegativeDynamicSearchAdTarget>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),
