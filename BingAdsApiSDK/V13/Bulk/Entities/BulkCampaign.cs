...
namespace Microsoft.BingAds.V13.Bulk.Entities
{
    ...
    public class BulkCampaign : SingleRecordBulkEntity
    {
        ...
        private static readonly IBulkMapping<BulkCampaign>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkCampaign>(StringTable.AISearchEnabled,
                c =>
                {
                    var setting = c.GetCampaignSetting(typeof(AISearchSetting)) as AISearchSetting;
                    if (setting != null)
                    {
                        return setting.AISearchEnabled.ToString();
                    }
                    return null;
                },
                (v, c) =>
                {
                    if (!string.IsNullOrEmpty(v))
                    {
                        var aiMaxSetting = c.GetCampaignSetting(typeof(AISearchSetting)) as AISearchSetting;
                        if (aiMaxSetting == null)
                        {
                            aiMaxSetting = new AISearchSetting();
                            if (c.Campaign.Settings == null)
                                c.Campaign.Settings = new List<Setting> { aiMaxSetting };
                            else
                                c.Campaign.Settings.Add(aiMaxSetting);
                        }
                        aiMaxSetting.AISearchEnabled = v.Parse<bool>();
                    }
                }
            ),
            new SimpleBulkMapping<BulkCampaign>(StringTable.UrlExpansionOptOut,
                c =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        return aiMaxSetting.FinalUrlExpansionOptOut.ToString();
                    }
                ...
                (v, c) =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        if (!string.IsNullOrEmpty(v))
                        {
                            aiMaxSetting.FinalUrlExpansionOptOut = v.Parse<bool>();
                        }
                        return;
                    }
            ...
            new SimpleBulkMapping<BulkCampaign>(StringTable.AutoGeneratedImageOptOut,
                c =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        return aiMaxSetting.AutoGeneratedImageOptOut.ToString();
                    }
                    var setting = c.GetCampaignSetting(typeof(PerformanceMaxSetting)) as PerformanceMaxSetting;
                    if (setting != null)
                    {
                ...
                (v, c) =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        if (!string.IsNullOrEmpty(v))
                        {
                            aiMaxSetting.AutoGeneratedImageOptOut = v.Parse<bool>();
                        }
                        return;
                    }
                    var setting = (c.GetCampaignSetting(typeof(PerformanceMaxSetting), true)) as PerformanceMaxSetting;
            ...
            new SimpleBulkMapping<BulkCampaign>(StringTable.AutoGeneratedTextOptOut,
                c =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        return aiMaxSetting.AutoGeneratedTextOptOut.ToString();
                    }
                    var setting = c.GetCampaignSetting(typeof(PerformanceMaxSetting)) as PerformanceMaxSetting;
                    if (setting != null)
                    {
                ...
                (v, c) =>
                {
                    ...
                    if (aiMaxSetting != null)
                    {
                        if (!string.IsNullOrEmpty(v))
                        {
                            aiMaxSetting.AutoGeneratedTextOptOut = v.Parse<bool>();
                        }
                        return;
                    }
                    var setting = (c.GetCampaignSetting(typeof(PerformanceMaxSetting), true)) as PerformanceMaxSetting;
            ...
            new SimpleBulkMapping<BulkCampaign>(StringTable.SearchTermMatchingOptOut,
                c =>
                {
                    var setting = c.GetCampaignSetting(typeof(AISearchSetting)) as AISearchSetting;
                    if (setting != null)
                    {
                        return setting.SearchTermMatchingOptOut.ToString();
                    }
                    return null;
                },
                (v, c) =>
                {
                    ...
                    if (setting != null && !string.IsNullOrEmpty(v))
                    {
                        setting.SearchTermMatchingOptOut = v.Parse<bool>();
                    }
                }
            ),
