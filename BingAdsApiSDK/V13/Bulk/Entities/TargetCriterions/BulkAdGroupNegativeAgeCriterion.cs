...
namespace Microsoft.BingAds.V13.Bulk.Entities
{
    /// <summary>
    /// <para>
    /// This class exposes the <see cref="NegativeAdGroupCriterion"/> property with AgeCriterion that can be read and written as fields of the Ad Group Negative Age Criterion record in a bulk file. 
    /// </para>
    /// <para>For more information, see <see href="https://go.microsoft.com/fwlink/?linkid=846127">Ad Group Negative Age Criterion</see>. </para>
    /// </summary>
    ...
    public class BulkAdGroupNegativeAgeCriterion : BulkAdGroupNegativeCriterion
    {
        ...
        {               
            new SimpleBulkMapping<BulkAdGroupNegativeAgeCriterion>(StringTable.Target,
                c =>
                {
                    var ageCriterion = c.NegativeAdGroupCriterion.Criterion as AgeCriterion;
