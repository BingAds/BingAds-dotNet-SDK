...
namespace Microsoft.BingAds.V13.Bulk.Entities
{
    ...
    public abstract class BulkEntity : BulkObject
    {
        ...
        protected void ValidatePropertyNotNull(object propertyValue, string propertyName)
        {
            ...
            {
                throw new InvalidOperationException(ErrorMessages.GetPropertyMustNotBeNullMessage(GetType().Name,
                    propertyName));
            }
        }
        ...
        protected void ValidateListNotNullOrEmpty<T>(IList<T> listValue, string propertyName)
        {
            ...
            {
                throw new InvalidOperationException(ErrorMessages.GetListMustNotBeEmptyMessage(GetType().Name,
                    propertyName));
            }
        }
    }
