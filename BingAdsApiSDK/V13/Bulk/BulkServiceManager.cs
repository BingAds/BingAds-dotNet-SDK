...
namespace Microsoft.BingAds.V13.Bulk
{
    ...
    public class BulkServiceManager
    {
        ...
        /// <summary>
        /// Directory for storing temporary files needed for some operations (for example <see cref="UploadEntitiesAsync(Microsoft.BingAds.V13.Bulk.EntityUploadParameters)"/> creates a temporary upload file).
        /// </summary>
