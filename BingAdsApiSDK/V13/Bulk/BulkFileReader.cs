...
namespace Microsoft.BingAds.V13.Bulk
{
    ...
    public class BulkFileReader : BulkEntityReader
    {
        ...
        /// </summary>
        public string BulkFilePath { get; }
        ...
        public BulkFileReader(string filePath, ResultFileType resultFileType, Bulk.DownloadFileType fileFormat) : base(new BulkStreamReader(filePath, fileFormat))
        {
        ...
        /// <param name="resultFileType">The result file type.</param>
        /// <param name="fileFormat">The bulk file format.</param>
        public BulkFileReader(Stream stream, ResultFileType resultFileType, Bulk.DownloadFileType fileFormat) : base(new BulkStreamReader(stream, fileFormat))
        {
            _isForFullDownload = resultFileType == ResultFileType.FullDownload;
        }
        ...
        protected override bool IsForFullDownload()
        {
            return _isForFullDownload;
        }
