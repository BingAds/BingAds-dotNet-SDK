...
namespace Microsoft.BingAds.Internal.Bulk
{
    ...
    {
        public static readonly string[] SemanticVersions = { "1.0", "2.0", "3.0" };
        public static readonly string SemanticVersionDefault = SemanticVersions[0];
        ...
        public const string SearchNetwork = "Search Network";
        public const string ContentNetwork = "Content Network";
        public const string PricingModel = "Pricing Model";
        public const string Language = "Language";
        public const string SearchBroadBid = "Search Broad Bid";
        ...
        public const string ProductCondition8 = "Product Condition 8";
