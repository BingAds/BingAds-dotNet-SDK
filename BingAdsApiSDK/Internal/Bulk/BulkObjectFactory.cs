    ...
    internal class BulkObjectFactory : IBulkObjectFactory
    {
        ...
        static BulkObjectFactory()
        {
            IndividualEntityMap = new Dictionary<string, EntityInfo>
            {
                ...
                {StringTable.MobileAd,                      new EntityInfo(() => new BulkMobileAd())},
                ...
                {StringTable.ProductAdExtension,            new EntityInfo(() => new BulkProductConditionCollection(),          StringTable.BingMerchantCenterId,   () => new BulkProductAdExtensionIdentifier())},
                {StringTable.CampaignProductAdExtension,    new EntityInfo(() => new BulkCampaignProductAdExtension())},
