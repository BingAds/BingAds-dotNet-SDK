...
namespace Microsoft.BingAds.V12.Internal.Bulk.Entities
{
    /// <summary>
    /// <para>This abstract class provides properties that are shared by all bulk ad extension classes.</para>
    /// </summary>
    /// <typeparam name="T">The type of ad extension from the <see cref="Microsoft.BingAds.V12.CampaignManagement"/> namespace, for example a <see cref="CallAdExtension"/> object.</typeparam>
        ...
        where T: AdExtension
    {
        ...
        /// <summary>
        /// The type of ad extension from the <see cref="Microsoft.BingAds.V12.CampaignManagement"/> namespace, for example a <see cref="CallAdExtension"/> object.
        /// </summary>
