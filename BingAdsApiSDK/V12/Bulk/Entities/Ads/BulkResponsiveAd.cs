...
namespace Microsoft.BingAds.V12.Bulk.Entities
{
    ...
    public class BulkResponsiveAd : BulkAd<ResponsiveAd>
    {
        ...
        private static readonly IBulkMapping<BulkResponsiveAd>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkResponsiveAd>(StringTable.LandscapeImageMediaId,
                c => c.ResponsiveAd.LandscapeImageMediaId.ToBulkString(),
                (v, c) => c.ResponsiveAd.LandscapeImageMediaId = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkResponsiveAd>(StringTable.LandscapeLogoMediaId,
                c => c.ResponsiveAd.LandscapeLogoMediaId.ToBulkString(),
                (v, c) => c.ResponsiveAd.LandscapeLogoMediaId = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkResponsiveAd>(StringTable.SquareImageMediaId,
                c => c.ResponsiveAd.SquareImageMediaId.ToBulkString(),
                (v, c) => c.ResponsiveAd.SquareImageMediaId = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkResponsiveAd>(StringTable.SquareLogoMediaId,
                c => c.ResponsiveAd.SquareLogoMediaId.ToBulkString(),
                (v, c) => c.ResponsiveAd.SquareLogoMediaId = v.ParseOptional<long>()
            ),
