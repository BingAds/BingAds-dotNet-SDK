...
namespace Microsoft.BingAds.V12.Bulk.Entities
{
    ...
    public class BulkAdGroupNegativeRemarketingListAssociation : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>[] Mappings =
        {
            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.Id,
                c => c.NegativeAdGroupCriterion.Id.ToBulkString(),
                (v, c) => c.NegativeAdGroupCriterion.Id = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.ParentId,
                c => c.NegativeAdGroupCriterion.AdGroupId.ToBulkString(true),
                (v, c) => c.NegativeAdGroupCriterion.AdGroupId = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.Audience,
                c => c.RemarketingListName,
                (v, c) => c.RemarketingListName = v
            ),
            
            new SimpleBulkMapping<BulkAdGroupNegativeRemarketingListAssociation>(StringTable.AudienceId,
                c =>
                {
