...
namespace Microsoft.BingAds.V12.Bulk.Entities
{
    ...
    public class BulkAdGroupNegativeGenderCriterion : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        {
            new SimpleBulkMapping<BulkAdGroupNegativeGenderCriterion>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupNegativeGenderCriterion>(StringTable.Id,
                c => c.NegativeAdGroupCriterion.Id.ToBulkString(),
                (v, c) => c.NegativeAdGroupCriterion.Id = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeGenderCriterion>(StringTable.ParentId,
                c => c.NegativeAdGroupCriterion.AdGroupId.ToBulkString(true),
                (v, c) => c.NegativeAdGroupCriterion.AdGroupId = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeGenderCriterion>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupNegativeGenderCriterion>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),
