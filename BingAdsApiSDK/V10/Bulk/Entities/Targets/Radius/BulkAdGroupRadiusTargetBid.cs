...
namespace Microsoft.BingAds.V10.Bulk.Entities
{
    ...
    public class BulkAdGroupRadiusTargetBid : BulkRadiusTargetBid
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the BulkAdGroupRadiusTargetBid class.
        /// </summary>
        public BulkAdGroupRadiusTargetBid()
            : base(new BulkAdGroupTargetIdentifier(typeof(BulkAdGroupRadiusTargetBid)))
        {
