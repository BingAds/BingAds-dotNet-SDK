...
namespace Microsoft.BingAds.V10.Bulk.Entities
{
    ...
    /// This class exposes the <see cref="BulkAdGroupRemarketingList.AdGroupRemarketingListAssociation"/> property that can be read and written as fields of the Ad Group Remarketing List Association record in a bulk file. 
    /// </para>
    ...
    public class BulkAdGroupRemarketingList : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupRemarketingList>[] Mappings =
        {
            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.Id,
                c => c.AdGroupRemarketingListAssociation.Id.ToBulkString(),
                (v, c) => c.AdGroupRemarketingListAssociation.Id = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.ParentId,
            ...
            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),

            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.BidAdjustment,
                c => c.AdGroupRemarketingListAssociation.BidAdjustment.ToBulkString(),
                (v, c) => c.AdGroupRemarketingListAssociation.BidAdjustment = v.Parse<double>()
            ),

            new SimpleBulkMapping<BulkAdGroupRemarketingList>(StringTable.RemarketingListId,
                c => c.AdGroupRemarketingListAssociation.RemarketingListId.ToBulkString(),
                (v, c) => c.AdGroupRemarketingListAssociation.RemarketingListId = v.Parse<long>()
            ),
