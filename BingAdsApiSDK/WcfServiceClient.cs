...
namespace Microsoft.BingAds
{
    ...
    /// </remarks>
    public class WcfServiceClient<TService> : IDisposable
        where TService : class
    {
        ...
        public WcfServiceClient(AuthorizationData authorizationData): this(authorizationData, null)
        {
        ...
        public WcfServiceClient(AuthorizationData authorizationData, ApiEnvironment? environment)
        {
        ...
        /// </summary>
        /// <remarks>You should use this method when finished with an instance of <see cref="WcfServiceClient{TService}"/>.</remarks>
        public void Dispose()
        {
            Dispose(true);
