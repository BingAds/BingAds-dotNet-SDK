...
namespace Microsoft.BingAds.V11.Bulk
{
    ...
    public class BulkServiceManager
    {
        ...
        internal const string FormatVersion = "5.0";
        ...
        /// <summary>
        /// Directory for storing temporary files needed for some operations (for example <see cref="UploadEntitiesAsync(Microsoft.BingAds.V11.Bulk.EntityUploadParameters)"/> creates a temporary upload file).
        /// </summary>
