...
namespace Microsoft.BingAds.V11.Bulk.Entities
{
    ...
    public class BulkAdGroupRemarketingListAssociation : SingleRecordBulkEntity
    {
        ...
        private static readonly IBulkMapping<BulkAdGroupRemarketingListAssociation>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkAdGroupRemarketingListAssociation>(StringTable.Audience,
            ...
            new SimpleBulkMapping<BulkAdGroupRemarketingListAssociation>(StringTable.AudienceId,
                c =>
                {
