...
namespace Microsoft.BingAds.V11.Bulk.Entities
{
    ...
    /// This class exposes the <see cref="BiddableAdGroupCriterion"/> property that can be read and written as fields of the Ad Group Custom Audience Association record in a bulk file. 
    /// </para>
    /// <para>For more information, see <see href="https://go.microsoft.com/fwlink/?linkid=846127">Ad Group Custom Audience Association</see> </para>
    /// </summary>
    /// <seealso cref="BulkServiceManager"/>
    /// <seealso cref="BulkOperation{TStatus}"/>
    /// <seealso cref="BulkFileReader"/>
    /// <seealso cref="BulkFileWriter"/>
    public class BulkAdGroupCustomAudienceAssociation : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupCustomAudienceAssociation>[] Mappings =
        {
            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.Id,
                c => c.BiddableAdGroupCriterion.Id.ToBulkString(),
                (v, c) => c.BiddableAdGroupCriterion.Id = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.ParentId,
                c => c.BiddableAdGroupCriterion.AdGroupId.ToBulkString(true),
                (v, c) => c.BiddableAdGroupCriterion.AdGroupId = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),

            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.Audience,
                c => c.CustomAudienceName,
                (v, c) => c.CustomAudienceName = v
            ),

            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.BidAdjustment,
                c =>
                {
            ...
            new SimpleBulkMapping<BulkAdGroupCustomAudienceAssociation>(StringTable.AudienceId,
                c =>
                {
