...
namespace Microsoft.BingAds.V11.Bulk.Entities
{
    ...
    /// This class exposes the <see cref="BiddableAdGroupCriterion"/> property that can be read and written as fields of the Ad Group Product Audience Association record in a bulk file. 
    /// </para>
    /// <para>For more information, see <see href="https://go.microsoft.com/fwlink/?linkid=846127">Ad Group Product Audience Association</see> </para>
    /// </summary>
    /// <seealso cref="BulkServiceManager"/>
    /// <seealso cref="BulkOperation{TStatus}"/>
    /// <seealso cref="BulkFileReader"/>
    /// <seealso cref="BulkFileWriter"/>
    public class BulkAdGroupProductAudienceAssociation : SingleRecordBulkEntity
    {
        /// <summary>
        ...
        /// <summary>
        /// The <see href="https://go.microsoft.com/fwlink/?linkid=846127">Ad Group</see> that is associated with the Product Audience.
        /// Corresponds to the 'Ad Group' field in the bulk file.
        /// </summary>
        public string AdGroupName { get; set; }

        /// <summary>
        /// The historical performance data for the Product Audience association.
        /// </summary>
        ...
        /// </summary>
        public string ProductAudienceName { get; set; }

        private static readonly IBulkMapping<BulkAdGroupProductAudienceAssociation>[] Mappings =
        {
            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.Status,
            ...
            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.Id,
                c => c.BiddableAdGroupCriterion.Id.ToBulkString(),
                (v, c) => c.BiddableAdGroupCriterion.Id = v.ParseOptional<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.ParentId,
                c => c.BiddableAdGroupCriterion.AdGroupId.ToBulkString(true),
                (v, c) => c.BiddableAdGroupCriterion.AdGroupId = v.Parse<long>()
            ),

            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.Campaign,
                c => c.CampaignName,
                (v, c) => c.CampaignName = v
            ),

            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.AdGroup,
                c => c.AdGroupName,
                (v, c) => c.AdGroupName = v
            ),

            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.Audience,
                c => c.ProductAudienceName,
                (v, c) => c.ProductAudienceName = v
            ),

            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.BidAdjustment,
                c =>
                {
            ...
            new SimpleBulkMapping<BulkAdGroupProductAudienceAssociation>(StringTable.AudienceId,
                c =>
                {
