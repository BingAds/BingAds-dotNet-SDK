...
namespace Microsoft.BingAds.V11.Bulk.Entities
{
    /// <summary>
    /// <para>
    /// This class exposes the <see cref="BiddableAdGroupCriterion"/> property with GenderCriterion that can be read and written as fields of the Ad Group Gender Criterion record in a bulk file. 
    /// </para>
    ...
    public class BulkAdGroupGenderCriterion : SingleRecordBulkEntity
    {
        ...
        private static readonly IBulkMapping<BulkAdGroupGenderCriterion>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkAdGroupGenderCriterion>(StringTable.Target,
                c =>
                {
                    var genderCriterion = c.BiddableAdGroupCriterion.Criterion as GenderCriterion;
