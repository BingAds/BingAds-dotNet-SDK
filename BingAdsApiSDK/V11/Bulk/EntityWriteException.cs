...
{
    /// <summary>
    /// This exception is thrown when attempting to write entities to a bulk file using <see cref="BulkFileWriter.WriteEntity(Microsoft.BingAds.V11.Bulk.Entities.BulkEntity)"/>.
