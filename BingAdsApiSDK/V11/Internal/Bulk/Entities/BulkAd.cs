...
namespace Microsoft.BingAds.V11.Internal.Bulk.Entities
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of ad from the <see cref="Microsoft.BingAds.V11.CampaignManagement"/> namespace, for example a <see cref="TextAd"/> object.</typeparam>
        ...
        where T: Ad, new()
    {
        ...
        /// <summary>
        /// The type of ad from the <see cref="Microsoft.BingAds.V11.CampaignManagement"/> namespace, for example a <see cref="TextAd"/> object.
        /// </summary>
