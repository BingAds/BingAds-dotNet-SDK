...
namespace Microsoft.BingAds.V11.Internal.Bulk.Entities
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of ad extension from the <see cref="Microsoft.BingAds.V11.CampaignManagement"/> namespace, for example a <see cref="CallAdExtension"/> object.</typeparam>
        ...
        where T: AdExtension
    {
        ...
        /// <summary>
        /// The type of ad extension from the <see cref="Microsoft.BingAds.V11.CampaignManagement"/> namespace, for example a <see cref="CallAdExtension"/> object.
        /// </summary>
