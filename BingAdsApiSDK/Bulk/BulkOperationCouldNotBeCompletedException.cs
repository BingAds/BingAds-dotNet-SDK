...
{    
    ...
    public class BulkOperationCouldNotBeCompletedException<TStatus> : Exception
    {
        ...
        /// <para>For bulk download, this value corresponds to the <see cref="GetDetailedBulkDownloadStatusResponse.RequestStatus"/> property.</para>
        /// <para>For bulk upload, this value corresponds to the <see cref="GetDetailedBulkUploadStatusResponse.RequestStatus"/> property.</para>
        /// </summary>
