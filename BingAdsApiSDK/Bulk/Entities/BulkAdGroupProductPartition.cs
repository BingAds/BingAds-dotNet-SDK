...
namespace Microsoft.BingAds.Bulk.Entities
{
    ...
    /// </para>
    /// <para>For more information, see Ad Group Product Partition at http://go.microsoft.com/fwlink/?LinkId=618642 </para>
    /// </summary>
        ...
        private static readonly IBulkMapping<BulkAdGroupProductPartition>[] Mappings =
        {
            ...
            new SimpleBulkMapping<BulkAdGroupProductPartition>(StringTable.DestinationUrl,
                c =>
                {
                    ...
                    if (criterion != null)
                    {
                        return criterion.DestinationUrl;
                    }
