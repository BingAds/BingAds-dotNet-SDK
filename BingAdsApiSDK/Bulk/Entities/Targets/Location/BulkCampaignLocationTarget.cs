...
namespace Microsoft.BingAds.Bulk.Entities
{
    ...
    /// that represent geographical location sub types. Each sub type can be read and written as fields of the Campaign Location Target record in a bulk file.       
    /// </summary>
    /// <remarks>
    ...
    /// corresponds to one Campaign Location Target record in the bulk file. If you upload a <see cref="BulkLocationTarget{TBid}.CityTarget"/>, 
    ...
    /// </para>
    /// <para>For more information, see Campaign Location Target at http://go.microsoft.com/fwlink/?LinkID=511525. </para>
    /// </remarks>
    /// <seealso cref="BulkServiceManager"/>
    /// <seealso cref="BulkOperation{TStatus}"/>
    /// <seealso cref="BulkFileReader"/>
    /// <seealso cref="BulkFileWriter"/>
    public class BulkCampaignLocationTarget : BulkLocationTarget<BulkCampaignLocationTargetBid>
    {
        /// <summary>
        ...
        /// </summary>
        protected internal override BulkCampaignLocationTargetBid CreateBid()
        {
