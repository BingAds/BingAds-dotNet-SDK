...
namespace Microsoft.BingAds.Bulk.Entities
{
    ...
    public class BulkAdGroupNegativeLocationTargetBid : BulkNegativeLocationTargetBid
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the BulkAdGroupNegativeLocationTargetBid class.
        /// </summary>
        public BulkAdGroupNegativeLocationTargetBid()
            : base(new BulkAdGroupTargetIdentifier(typeof(BulkAdGroupNegativeLocationTargetBid)))
        {
