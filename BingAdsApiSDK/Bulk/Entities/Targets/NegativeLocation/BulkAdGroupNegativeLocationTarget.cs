...
namespace Microsoft.BingAds.Bulk.Entities
{
    ...
    /// This class exposes the <see cref="BulkNegativeLocationTarget{TBid}.CityTarget"/>, <see cref="BulkNegativeLocationTarget{TBid}.CountryTarget"/>, 
    /// <see cref="BulkNegativeLocationTarget{TBid}.MetroAreaTarget"/>, <see cref="BulkNegativeLocationTarget{TBid}.PostalCodeTarget"/>, and <see cref="BulkNegativeLocationTarget{TBid}.StateTarget"/> properties 
    /// that represent geographical location sub types. Each sub type can be read and written as fields of the Ad Group Negative Location Target record in a bulk file.     
    /// </summary>
    /// <remarks>
    ...
    public class BulkAdGroupNegativeLocationTarget : BulkNegativeLocationTarget<BulkAdGroupNegativeLocationTargetBid>
    {
        /// <summary>
        ...
        /// </summary>
        protected internal override BulkAdGroupNegativeLocationTargetBid CreateBid()
        {
