...
{
    public class Microsoft_BingAds_V13_CustomerManagement_AllPolymorphicConverters
    {
        public static void AddTo(JsonSerializerOptions options, Func<string, Exception> createUnsupportedTypeValueException)
        {
            ...
            options.Converters.Add(new Microsoft_BingAds_V13_CustomerManagement_ApplicationFaultConverter(originalOptions, createUnsupportedTypeValueException));
        }
    }

    class Microsoft_BingAds_V13_CustomerManagement_ApplicationFaultConverter : JsonConverter<ApplicationFault>
    {
        ...
        public Microsoft_BingAds_V13_CustomerManagement_ApplicationFaultConverter(JsonSerializerOptions originalOptions, Func<string, Exception> createUnsupportedTypeValueException)
        {
