...
{
    public class Microsoft_BingAds_V13_Bulk_AllPolymorphicConverters
    {
        public static void AddTo(JsonSerializerOptions options, Func<string, Exception> createUnsupportedTypeValueException)
        {
            ...
            options.Converters.Add(new Microsoft_BingAds_V13_Bulk_ApplicationFaultConverter(originalOptions, createUnsupportedTypeValueException));
            options.Converters.Add(new Microsoft_BingAds_V13_Bulk_BatchErrorConverter(originalOptions, createUnsupportedTypeValueException));
        }
    }

    class Microsoft_BingAds_V13_Bulk_ApplicationFaultConverter : JsonConverter<ApplicationFault>
    {
        ...
        public Microsoft_BingAds_V13_Bulk_ApplicationFaultConverter(JsonSerializerOptions originalOptions, Func<string, Exception> createUnsupportedTypeValueException)
        {
    ...
    class Microsoft_BingAds_V13_Bulk_BatchErrorConverter : JsonConverter<BatchError>
    {
        private readonly JsonSerializerOptions _originalOptions;

        private readonly Func<string, Exception> _createUnsupportedTypeValueException;

        public Microsoft_BingAds_V13_Bulk_BatchErrorConverter(JsonSerializerOptions originalOptions, Func<string, Exception> createUnsupportedTypeValueException)
        {
            _originalOptions = originalOptions;
