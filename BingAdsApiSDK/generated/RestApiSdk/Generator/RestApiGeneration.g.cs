...
public static partial class RestApiGeneration
{
    ...
    public static void Apply(JsonSerializerOptions jsonSerializationOptions, Func<string, Exception> createUnsupportedTypeValueException)
    {
        ...
        Microsoft_BingAds_V13_CampaignManagement_AllPolymorphicConverters.AddTo(jsonSerializationOptions, createUnsupportedTypeValueException);
        Microsoft_BingAds_V13_CustomerBilling_AllPolymorphicConverters.AddTo(jsonSerializationOptions, createUnsupportedTypeValueException);
        Microsoft_BingAds_V13_CustomerManagement_AllPolymorphicConverters.AddTo(jsonSerializationOptions, createUnsupportedTypeValueException);
        Microsoft_BingAds_V13_Reporting_AllPolymorphicConverters.AddTo(jsonSerializationOptions, createUnsupportedTypeValueException);
    }
}