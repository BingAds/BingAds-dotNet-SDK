...
namespace Microsoft.BingAds.Optimizer
{
    ...
    public interface IOptimizerService
    {
        ...
        /// <para>Currently keyword opportunities are only available in these markets: Australia (AU), Canada (CA), France (FR), Germany (DE), Hong Kong (HK), Taiwan (TW), United Kingdom (GB), and United States (US). It is not recommended to use this service operation for accounts in other markets.</para>
        /// </summary>
        /// <remarks>
