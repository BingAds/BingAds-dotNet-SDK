...
namespace Microsoft.BingAds.V10.AdInsight
{
    ...
    /// <summary>
    /// <para>Defines the possible bid opportunity types you can request when calling GetBidOpportunities.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the suggested bid with estimated clicks and impressions opportunities.</para>
    ...
    /// <summary>
    /// <para>This is the base class from which opportunity objects derive. The class contains the unique key used to identify the opportunity.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the suggested budget with estimated clicks and impressions opportunities. Additionally, the object contains a list of budget points with weekly impressions, clicks and cost estimates for the given budget amount.</para>
    ...
    /// <summary>
    /// <para>Defines an object that contains a suggested keyword and bid value.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the marketplace impact statistics of including broad match type keyword bids.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a budget amount and an estimate of weekly impressions, clicks, and cost for this budget amount.</para>
    ...
    /// <summary>
    /// <para>Defines the possible types of campaign budgets.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible values of a campaign budget point.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains search query statistics of including broad match type keyword bids.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the base object from which all fault detail objects derive.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines a fault object that operations return when generic errors occur, such as an authentication error.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines a fault object that operations return when web service-specific errors occur, such as when the request message contains incomplete or invalid data.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an error object that identifies the item within the batch of items in the request message that caused the operation to fail, and describes the reason for the failure.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an error object that contains the details that explain why the service operation failed.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible keyword opportunity types you can request when calling GetKeywordOpportunities.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible positions where you can target an ad to appear in the search results or on a content-based webpage.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the identifier of the keyword and the suggested bid value for the keyword and match type.</para>
    ...
    /// <summary>
    /// <para>Defines an object that contains the keyword and the estimated bid value for each match type.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains estimates of clicks, average cost per click (CPC), impressions, click-through rate (CTR), and total cost for the corresponding keyword or ad group given the suggested bid.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines a selection of currency values.</para>
    ...
    /// <summary>
    /// <para>Defines the possible keyword match type values.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the identifier of a keyword and the estimated search results position for the keyword and match type.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the keyword and the estimated position in the search results for each match type.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the estimated search results position and estimated keyword statistics such as clicks, average cost per click (CPC), impressions, click-through rate (CTR), and total cost for the specified keyword given the specified bid.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a keyword and corresponding match types.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the requested bid landscape type for the corresponding ad group identifier.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible values that indicate whether all or a subset of an ad group's existing keywords are used to determine the bid landscape.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a list of estimated clicks, cost, and impressions from 1 to 7 days for the ad group identifier given the suggested bid.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that you use to specify the start and end dates of a date range.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains estimates of clicks, cost, and impressions given the suggested bid.</para>
    ...
    /// <summary>
    /// <para>Defines an object that contains a list of estimated clicks, cost, and impressions from 1 to 7 days for the keyword identifier given the suggested bid.</para>
    /// <para>The estimates are not a prediction or guarantee of future performance.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible time periods that determine the pool of data that the service uses to get the performance statistics of a keyword.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines the possible positions of an ad in the search results or on a content-based webpage.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the key performance index data for the specified keyword.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines a key performance index object for a keyword. The object contains the historical performance statistics of the keyword for the corresponding match type, ad position, device, and network.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a list of search counts for each device and network where the keyword was included in a search query. The data is aggregated based on the attributes specified in the request.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a list of keyword historical search counts for the corresponding device attribute. Each search count in the list is aggregated by day, month, and year.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the number of times that the keyword was used in a search query during the specified time period.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the keyword and a list of keyword categories that the keyword might belong to.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a keyword category and a confidence score. The confidence score indicates the likelihood that the keyword belongs to the keyword category.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the keyword and percentage of users by age and gender (if known) who searched for the specified keyword.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the device, age and gender of the user who entered the search query, if known.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the locations where users were located when they searched for the specified keyword.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains the location, network, device, and the percentage of time that a user entered a search query.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a suggested keyword and a confidence score. The confidence score indicates the probability that the keyword would match a user's search query.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// <para>Defines an object that contains a list of suggested keywords that may perform better than the specified keyword.</para>
    /// </summary>
    /// <remarks>
    ...
    public interface IAdInsightService
    {
        ...
        /// <summary>
        /// <para>Gets the keyword bid opportunities of the specified ad group.</para>
        ...
        /// <summary>
        /// <para>Gets the campaign budget opportunities of the specified campaign.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets a list of keyword suggestions that are relevant to the specified ad group. The keyword suggestion also includes a suggested bid value.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the estimated position in the search results if the specified bid value had been used for the keywords in the last 7 days. In addition, the operation provides estimates of clicks, average cost per click (CPC), and impressions that the keywords could have generated with the estimated bid.</para>
        /// <para>The estimates are based on the last 7 days of performance data, and not a prediction or guarantee of future performance.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the estimated bid value of one or more keywords that could result in an ad appearing in the targeted position in the search results.</para>
        /// <para>The estimates are not a prediction or guarantee of future performance.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the estimated position in the search results if the specified bid value would be used for the specified keywords. In addition, the operation provides estimates of clicks, average cost per click (CPC), and impressions that the keywords could be generated with the estimated bid.</para>
        /// <para>The estimates are not a prediction or guarantee of future performance.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Given a list of existing ad groups, this operation returns for each a list of suggested bids and estimated performance statistics. You can use the landscape view of multiple bid points with estimated traffic for the same ad group to help make decisions about how to adjust your ad group level default bid to optimize for clicks, impressions, and cost. For example you might use the resulting data to visualize a clicks to cost curve or a bid to impressions curve.</para>
        /// <para>The estimates are based on the last 7 days of performance data, and not a prediction or guarantee of future performance.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Given a list of existing keywords, this operation returns for each a list of suggested bids and estimated performance statistics. You can use the landscape view of multiple bid points with estimated traffic for the same keyword to help make decisions about how to adjust your keyword bid to optimize for clicks, impressions, and cost. For example you might use the resulting data to visualize a clicks to cost curve or a bid to impressions curve.</para>
        /// <para>The estimates are based on the last 7 days of performance data, and not a prediction or guarantee of future performance.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the historical performance of the normalized search term. The results are aggregated by device type.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the number of times the normalized term was used in a search during the specified time period. The results are aggregated by device type.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the keyword categories to which the specified keywords belong.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the age and gender of users who have searched for the specified keywords.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Gets the geographical locations of users who have searched for the specified keywords.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Suggests the possible keywords for the content located at the specified URL.</para>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Suggests keywords that could perform better than the specified keywords.</para>
        /// </summary>
        /// <remarks>
