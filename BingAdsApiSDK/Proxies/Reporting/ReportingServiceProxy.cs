...
namespace Microsoft.BingAds.Reporting
{
    ...
    /// <para>Defines a product dimension performance report request that aggregates the performance data by product category, custom label, title, and type for a specified time period. You can include details in the report such as impressions, clicks, and spend that you can use to identify whether or not the product dimensions are performing well.</para>
    /// <para>To request a report of this type, pass this object to the SubmitGenerateReport operation.</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// This feature is currently in pilot and will be generally available soon.
    /// <para>Defines a product partition performance report request that aggregates the performance data by product group and product partition type for a specified time period. You can include details in the report such as impressions, clicks, and spend that you can use to identify whether or not the product partitions are performing well.</para>
    /// <para>To request a report of this type, pass this object to the SubmitGenerateReport operation.</para>
    /// </summary>
    /// <remarks>
